...
num_codebooks="16,8"
delta="0,0"
frame_rate_ratio="1,1"
num_cb_speech=16
num_cb_audio=8
speech_mvq_loss_scale=1.0
audio_mvq_loss_scale=0.25
...
as-${audioset_subset}-x${repeat_audioset}-vgg-bbc-fs-m4a-${use_music4all}-mtg-\
...
multi-mvq-wavlm-large-cb16-${speech_mvq_loss_scale}-dasheng-cb8-${audio_mvq_loss_scale}-\
md${max_duration}
...
torchrun --nproc_per_node=8 \
  ...
  zipformer_audio_encoder/train_multi_KD3_shar_speech_audio_multi_mvq.py \
    ...
    --audio-shar-dir data-shar/data-shar-dasheng-as-cb8 \
