...
giga-${gigaspeech_subset}-lh-${libriheavy_subset}-mask-prob-${mask_prob}-musan-${enable_musan}-rir-${enable_rir}-\
hubert-large-layer-21-libri-mvq-cb${num_codebooks}-md-${max_duration}-shar
