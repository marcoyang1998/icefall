...
exp_dir=zipformer_audio_encoder/exp-full-libri-96M-zipformer-streaming\
-whisper-mvq-pad-embed-mask-ratio-${time_mask_ratio}-musan-${enable_musan}
...
torchrun \
  ...
  zipformer_audio_encoder/train_multi_KD3_shar.py \
    ...
    --start-epoch 1 \
    --max-iter 300000 \
    --use-shar $use_shar --shar-dir data-shar-whisper-mvq-pad \
    --base-lr $lr \
    --use-fp16 1 \
    --exp-dir $exp_dir \
    ...
    --causal 1 \
    --chunk-size 8,32,-1 --left-context-frames 128,256,-1 \
    --manifest-dir data/vq_whisper_turbo_zh_en_16_pad_v3 \
