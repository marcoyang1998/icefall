...
finetune_ckpt=zipformer_audio_encoder/exp-wenetspech-L-96M-zipformer-non-streaming-firered-mvq-wenet-S-zh-cb16-out-ds-2-mask-ratio-1.0-musan-0/iter-200000-avg-4.pt
...
exp_dir=zipformer_audio_encoder_finetune/exp-finetune-95M-wenet-S-\
lr-${lr}-causal-${causal}-freeze-encoder-${freeze_encoder}\
-freeze-${freeze_encoder_steps}-step-encoder-lr-scale-${encoder_lr_scale}\
-from-firered-en-zh-mvq-cb16-no-musan-mask-ratio-1.0-200k
