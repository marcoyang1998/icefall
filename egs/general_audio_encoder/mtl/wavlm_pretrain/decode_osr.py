#!/usr/bin/env python3
#
# Copyright 2025 University of Cambridge (Author: Xiaoyu Yang)
#
...
Usage:
(1) attention decoder
./wavlm_pretrain/decode_osr.py \
    --epoch 28 \
    --avg 15 \
    --exp-dir ./wavlm_pretrain/exp \
    --max-duration 600 \
    --decoding-method attention_decoder
"""
...
def decode_one_batch(
    ...
    encoder_out, encoder_out_lens = model.forward_encoder(audio_waveform, audio_lens)
