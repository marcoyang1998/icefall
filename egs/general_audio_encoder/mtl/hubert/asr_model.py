...
class AsrModel(nn.Module):
    ...
    def forward_encoder(
        ...
        """
        features, embedding_lens = self.encoder.extract_features(batch, layer_idx=self.layer_idx)
        return features, embedding_lens
    ...
    def forward(
        ...
        assert not self.use_attention_decoder
