...
def extract_embeddings(
    ...
    setup_logger(f"data/embeddings/log/log-firered-embeddings")
    ...
    logging.info(f"Finished extracting firered embeddings, processed a total of {num_cuts} cuts.")
