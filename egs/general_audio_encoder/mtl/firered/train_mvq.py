...
def main(args):
    ...
    # evaluate quantizer
    valid_manifests = [
        "data/manifests/firered/firered-layer--1-wenet-DEV-trimmed.jsonl.gz",
        "data/manifests/firered/firered-layer--1-aishell-test.jsonl.gz",
        "data/manifests/firered/firered-layer--1-dev-clean.jsonl.gz",
        "data/manifests/firered/firered-layer--1-dev-other.jsonl.gz",
        "data/manifests/firered/firered-layer--1-giga-dev.jsonl.gz",
    ]
