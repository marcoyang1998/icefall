...
class MultiTaskKDDataset(torch.utils.data.Dataset):
    ...
    * ``F`` - number of features
    ...
    def __init__(
        ...
        self.dummy_at_codebook_indexes = torch.ones(1510, 16) * (-100)
    ...
    def __getitem__(self, cuts: CutSet) -> Dict[str, Union[torch.Tensor, List[str]]]:
        ...
        batch = {
            ...
            "audio_cb_indexes": audio_mvq_tokens,
            "audio_cb_indexes_len": audio_mvq_token_lens,
...
def _collate_custom_field(
    ...
    if temporal_array:
        max_frames = [int(c.duration / frame_shift) for c in cuts]
