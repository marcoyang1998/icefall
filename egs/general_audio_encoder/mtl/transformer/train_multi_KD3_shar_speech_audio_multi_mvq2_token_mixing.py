...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="If True, causal self-attention.",
    )
...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        ...
        # TODO: make the scaling of MVQ losses an option
        # This is to match the zipformer loss scaling
    ...
    with warnings.catch_warnings():
        ...
        info["frames"] = (feature_lens // (params.subsampling_factor * params.output_downsampling_factor)).sum().item()
...
def compute_validation_loss(
    ...
    for batch_idx, batch in enumerate(valid_dl):
        with torch.amp.autocast("cuda", enabled=params.use_autocast, dtype=params.dtype):
