...
def _test_inference():
    ...
    checkpoint_path = "transformer_finetune/exp-finetune-420m-causal-1-sub-4-ls-960--lr-3e-5-cosine-scheduler-warmup-12000-causal-1-freeze-encoder-0-freeze--1-step-encoder-lr-scale-1.0-from-hubert-large-mvq-cb16-delta-6-lh-large-giga-xl-pt-attn-drop-0.1-cosine-sched-with-musan-no-rir-400k/epoch-999.pt"
