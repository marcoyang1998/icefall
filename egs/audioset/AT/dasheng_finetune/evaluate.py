...
def main():
    ...
    if params.weighted_combine:
        weights = model.layer_weight.softmax(-1).tolist()
        logging.info(f"The layer-wise weight is: {weights}")
    ...
    audioset_dl = audioset.waveform_test_dataloaders(audioset_cuts)
