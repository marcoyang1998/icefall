...
from train_mae_decoder_mask_with_replace_own_mask import add_model_arguments, get_model, get_params
...
def main():
    ...
    if params.jit is True:
        ...
        filename = params.exp_dir / f"pretrained-{params.epoch}-avg-{params.avg}.pt"
