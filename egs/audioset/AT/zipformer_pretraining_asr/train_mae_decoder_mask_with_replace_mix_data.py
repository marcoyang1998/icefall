...
def run(rank, world_size, args):
    ...
    libri_train_cuts = audioset.librispeech_train_all_shuf_cuts()
    libri_train_cuts = libri_train_cuts.map(add_audio_event)

    audioset_train_cuts = audioset.audioset_train_cuts()

    train_cuts = CutSet.mux(
        libri_train_cuts,
        audioset_train_cuts,
        weights=[843723,2000000],
        stop_early=True,
    )
