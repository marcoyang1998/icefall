...
python zipformer_co_training/train_mask_postions.py \
    --world-size 4 \
    --num-epochs 50 \
    --inf-check 0 \
    --exp-dir zipformer_co_training/exp_at_as_${subset}_co_training_frame_level_scale${co_training_scale}_specaug_downsample${output_downsampling_factor}_mask_position \
    --start-epoch 1 \
    --use-fp16 1 \
    --num-events 527 \
