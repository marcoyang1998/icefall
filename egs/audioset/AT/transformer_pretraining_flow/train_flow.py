...
./transformer_pretraining_flow/train_flow.py \
  --world-size 4 \
  --num-epochs 30 \
  --start-epoch 1 \
  --use-fp16 1 \
  --exp-dir transformer_pretraining_flow/exp \
...
from model_flow import AudioFlowModel
...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="The t used in flow for mixing fbank with noise"
    )
...
def get_model(params: AttributeDict) -> nn.Module:
    ...
    model = AudioFlowModel(
        ...
        num_heads_decoder=params.num_heads_decoder,
        input_dim=params.feature_dim,
        patch_width=params.patch_width,
        max_num_patches=1500, # fixed
