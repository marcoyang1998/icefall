...
def get_joiner_model(params: AttributeDict) -> nn.Module:
    joiner = Joiner(
        ...
        vocab_size=params.vocab_size + params.durations + 1,
    )
    return joiner
...
def get_model(params: AttributeDict) -> nn.Module:
    ...
    durations = [i for i in range(params.durations + 1)]
...
def compute_loss(
    ...
    if params.use_transducer:
        ...
        info["tdt_loss"] = tdt_loss.detach().cpu().item()
    if params.use_ctc:
