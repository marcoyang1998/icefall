...
def run(rank, world_size, args):
    ...
    # if params.do_speaker_verification:
    #     sv_test_cuts = librispeech.voxceleb_test_cuts()
    #     sv_test_cuts = sv_test_cuts.map(partial(_add_task_id, 3))
    #     sv_valid_dl = librispeech.valid_dataloaders(sv_test_cuts)
    #     valid_sets.append("SV_vox")
    #     valid_dls.append(sv_valid_dl)
