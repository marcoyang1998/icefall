...
from train import add_model_arguments, get_model, get_params, get_config
...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="If use fp16 when decoding"
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="If use bf16 when decoding"
    )
...
def decode_dataset(
    ...
    for batch_idx, batch in enumerate(dl):
        ...
        with torch.cuda.amp.autocast(enabled=params.use_fp16, dtype=torch.float16):
