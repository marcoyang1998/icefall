...
from dataset import SpeakerRecognitionDataset
...
class LibriSpeechSpeakerDataModule:
    """
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser):
        group = parser.add_argument_group(
            title="Speaker verification related options",
    ...
    def train_dataloaders(
        ...
        train = SpeakerRecognitionDataset(
