...
from audio_tagging_datamodule import AudiosetDataModule
...
from utils import str2multihot
...
def run(rank, world_size, args):
    ...
    audioset = AudiosetDataModule(args)
...
def main():
    parser = get_parser()
    AudiosetDataModule.add_arguments(parser)
