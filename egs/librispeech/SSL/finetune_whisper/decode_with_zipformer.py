...
from train_with_zipformer import add_model_arguments, get_model, get_params
...
from whisper_utils import replace_whisper_encoder_forward
...
def main():
    ...
    # dev_clean_cuts = librispeech.dev_clean_cuts().filter(remove_short_and_long_utt)
    # dev_other_cuts = librispeech.dev_other_cuts().filter(remove_short_and_long_utt)
