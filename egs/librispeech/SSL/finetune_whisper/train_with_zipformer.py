...
from model_with_zipformer import AsrModel
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    ...
    assert params.whisper_encoder_dim == model.dims.n_audio_state
...
def get_zipformer_encoder_model(params: AttributeDict):
    encoder = Zipformer2(
...
def get_model(params: AttributeDict) -> nn.Module:
    ...
    zipformer_encoder = get_zipformer_encoder_model(params)
    ...
    model = AsrModel(
        encoder=encoder,
        zipformer_encoder=zipformer_encoder,
        decoder=decoder,
        joiner=joiner,
        encoder_input_dim=_to_int_tuple(params.encoder_dim)[0],
        encoder_dim=max(_to_int_tuple(params.encoder_dim)),
        whisper_encoder_dim=params.whisper_encoder_dim,
        decoder_dim=params.decoder_dim,
        vocab_size=params.vocab_size,
