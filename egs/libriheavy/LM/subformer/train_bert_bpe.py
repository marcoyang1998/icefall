...
from lm_datamodule3 import LmDataset
...
def get_parser():
    ...
    parser.add_argument(
        ...
        help="BPE tokenizer for dataloaders"
    )
    ...
    params = AttributeDict(
        {
            ...
            "train_file_list": "train_npr.txt",
            "valid_file_list": "test_npr.txt",
            "num_workers": 4,
        }
    )
...
def train(
    ...
    for batch_idx_, batch in enumerate(train_dl):
        ...
        try:
            ...
            params.num_tokens_seen += params.tokens_per_segment * params.batch_size * get_world_size()
...
def run(rank, world_size, args):
    ...
    params.style_sampling_weight = list(map(float, params.style_sampling_weight.split()))
